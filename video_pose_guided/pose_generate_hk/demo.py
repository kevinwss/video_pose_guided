...
for itr in range(1):   #modify to 1
    #g1_feed, conditional_image, target_image, target_morphologicals = dataloader.next_batch(cfg.BATCH_SIZE_G2D, trainorval='TRAIN',targetimg_path = kp_file)
    
    g1_feed, conditional_image, target_image, target_morphologicals = dataloader.next_batch(batch_size, trainorval='TRAIN',targetimg_path = kp_file)
