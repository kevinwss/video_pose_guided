...
class DataLoader:
    ...
    def process_oneimg(self, fulldir,only_img = False):
    ...
    def next_batch(self, batch_size, trainorval):
        ...
        for i in range(batch_size):
            ...
            conditional_image[i], _,_ = self.process_oneimg(condimg_dir,True)
            
            #targetimg_dir = self.index2dir[pairstofeed[i][1]]
            targetimg_dir = "/data/shaoswan/phd/motion/pose_generate_hk/dataset/kick004/" + str(i+1) +".jpg"
